...
- Direct activation result classification and navigation-result translation are now pure, and controller tests no longer require the Qt model, but wheel/context activation planning and controller/backend integration-style activation coverage remain open.
