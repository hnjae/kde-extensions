...
- Interaction helpers: normal task drag MIME payload creation, source-index parsing, drop acceptance policy, task-like context-menu request payload construction, shared task-like activation/context-menu trigger wiring, and shared task-like icon rendering now have focused owners. Remaining task-like chrome work is extracting shared frame/content layout after the interaction surface stays stable.
