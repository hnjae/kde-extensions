...
- Scope policy: model filter settings now have a named owner; remaining scope work is to decide whether local qualifiers should also move behind a single scope-policy facade without weakening the current defensive checks.
