...
- Metrics: root layout, normal task, and attention task size constants and task-like title visibility now come from `TaskMetricsLogic.js`. Badge dimensions remain badge-local rendering policy.
